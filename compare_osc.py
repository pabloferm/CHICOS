...
U = np.array(
    [
        [
            cos_theta_12 * cos_theta_13,
            sin_theta_12 * cos_theta_13,
            sin_theta_13 * np.exp(-1j * delta_cp),
        ],
        [
            -sin_theta_12 * cos_theta_23
            - cos_theta_12 * sin_theta_23 * sin_theta_13 * np.exp(1j * delta_cp),
            cos_theta_12 * cos_theta_23
            - sin_theta_12 * sin_theta_23 * sin_theta_13 * np.exp(1j * delta_cp),
            sin_theta_23 * cos_theta_13,
        ],
        [
            sin_theta_12 * sin_theta_23
            - cos_theta_12 * cos_theta_23 * sin_theta_13 * np.exp(1j * delta_cp),
            -cos_theta_12 * sin_theta_23
            - sin_theta_12 * cos_theta_23 * sin_theta_13 * np.exp(1j * delta_cp),
