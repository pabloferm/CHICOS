...
# PMNS mixing matrix
U = sp.Matrix([
    [sp.cos(theta_12) * sp.cos(theta_13), sp.sin(theta_12) * sp.cos(theta_13), sp.sin(theta_13)],
    [-sp.sin(theta_12) * sp.cos(theta_23) - sp.cos(theta_12) * sp.sin(theta_13) * sp.sin(theta_23),
     sp.cos(theta_12) * sp.cos(theta_23) - sp.sin(theta_12) * sp.sin(theta_13) * sp.sin(theta_23),
     sp.cos(theta_13) * sp.sin(theta_23)],
    [sp.sin(theta_12) * sp.sin(theta_23) - sp.cos(theta_12) * sp.sin(theta_13) * sp.cos(theta_23),
     -sp.cos(theta_12) * sp.sin(theta_23) - sp.sin(theta_12) * sp.sin(theta_13) * sp.cos(theta_23),
     sp.cos(theta_13) * sp.cos(theta_23)]
])

# Define mass eigenstates evolution
M_diag = sp.diag(0, Delta_m21 / (2 * E), Delta_m31 / (2 * E))  # Mass-squared differences
